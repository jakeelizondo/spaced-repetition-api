      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'cola', translation: 'line' },
            { original: 'lata', translation: 'can' },
            { original: 'pueblo', translation: 'town' },
            { original: 'recuerdo', translation: 'memory' },
            { original: 'capricho', translation: 'whim' },
          ],
        };
        return supertest(app)
          .post('/api/user')
